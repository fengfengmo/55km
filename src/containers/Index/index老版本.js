    ...
    return (
      <div className="index_wrap">
        ...
        <div className="index_bg">
          ...
          <div className="index_header_main max_width960">
              ...
              {/*<Search placeholder="选择您想去的目的地" size={'large'} onSearch={(keyword)=>{
                  ...
                  <Select  size="large" placeholder="选择您想去的目的地" onChange={(value)=>{
        ...
        <div className="max_width960 index_main">
          <div className="popular_city_wrap">
            ...
            <div className="popular_city_body">
              <ul className="clearafter">
                ...
                <li>
                  <Link to='/search/Pattaya'>
                    <img src='http://7xq8kr.com1.z0.glb.clouddn.com/webapi_1486904110_sxj9d_40dng' />
                    <FormattedMessage id={'Destination.Pattaya'} defaultMessage='Pattaya' />
                  </Link>
                </li>
                <li>
          ...
          <div className="max_width960 index_main">
            ...
            <div className="reviews_wrap" >
              ...
              <div className="reviews_item">
                <h3>只想让您不虚此行</h3>
                <p>我们跑遍大街小巷，翻出不少生活在泰国又懂旅行的伙伴，邀请他们成为55公里“当地里手”，为您设计出一条又一条独具特色的一日行程。既包括了必去热门，还有不少小众特色。我们想让您一次就体验到双面的泰国，让您真正感觉不虚此行。</p>
              ...
              <div className="reviews_item">
                ...
                <p>All the Local Experts here are living or working in Thailand, they deeply know this country. They can show you a beautiful traveling place, at the same time, they will also bring you a wonderful culture experience. Join them, you won’t be disappointed!</p>
                <div className="reviews_item_con_bottom">
                  <Rate allowHalf defaultValue={5} disabled/>
                </div>
              </div>
