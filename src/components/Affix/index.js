...
export default class Affix extends React.Component {
  static propTypes = {
    ...
    targetWrap: React.PropTypes.func,
  ...
  updatePosition = (e) => {
    ...
    let { offsetTop, offsetBottom, offset, target ,targetWrap,offsetHeight} = this.props;
    ...
    // console.log(offsetMode.top)
    //console.log(scrollTop,targetWrap().offsetHeight)

    if (
      targetWrap && scrollTop > targetWrap().offsetHeight
    ) {
    ...
    }else if (scrollTop > elemOffset.top - offsetTop && offsetMode.top) {
      // Fixed Top
      if (affixStyle && affixStyle['align-self']==='flex-end') {
        this.setAffixStyle(e, null);
      }
      if (placeholderStyle && placeholderStyle['display']==='flex') {
        this.setPlaceholderStyle(e, null);
      }
      this.setAffixStyle(e, {
        position: 'fixed',
